...
export default function App() {
  return (
    <div>
      ...
      <section id="ai-experience"><AIExperience /></section>

      <footer className="site-footer">
        <a href="https://github.com/rotondojs/" target="_blank" rel="noreferrer" className="footer-link">
        ...
        <a href="https://www.linkedin.com/in/john-s-rotondo-0540a5229/" target="_blank" rel="noreferrer" className="footer-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
